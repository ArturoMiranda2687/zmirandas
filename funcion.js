...
const elas49 = new Deportiva({
    ...
    color:"",
    descripcion:"",
    imagen:"./media/prendas/elastano/e48.png",
    imagen2:"",
    esDeportiva: "true",
})
const elas50 = new Deportiva({
    ...
    color:"",
    descripcion:"",
    imagen:"./media/prendas/elastano/e49.png",
    imagen2:"",
    esDeportiva: "true",
})
const elas51 = new Deportiva({
    ...
    color:"",
    descripcion:"",
    imagen:"./media/prendas/elastano/e50.png",
    imagen2:"",
    imagen3:"",
    imagen4:"",
    imagen5:"",
...
const elas55 = new Deportiva({
    ...
    color:"",
    descripcion:"",
    imagen:"./media/prendas/elastano/e54.png",
    imagen2:"",
    imagen3:"",
    imagen4:"",
    imagen5:"",
...
const elas57 = new Deportiva({
    ...
    color:"",
    descripcion:"",
    imagen:"./media/prendas/elastano/e56.png",
    imagen2:"",
    imagen3:"",
    imagen4:"",
    imagen5:"",
...
const elas61 = new Deportiva({
    ...
    color:"",
    descripcion:"",
    imagen:"./media/prendas/elastano/e60.png",
    imagen2:"",
    imagen3:"",
    imagen4:"",
    imagen5:"",
...
prodcatelas.innerHTML += `<h4>${elas2.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas2.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas3.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas3.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas4.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas4.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas5.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas5.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas6.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas6.imagen}" alt=""></div> <div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas7.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas7.imagen}" alt=""></div> <div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas8.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas8.imagen}" alt=""></div> <div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas9.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas9.imagen}" alt=""></div> <div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas10.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas10.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas11.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas11.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas12.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas12.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas13.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas13.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas14.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas14.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas15.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas15.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas16.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas16.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas17.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas17.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas18.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas18.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas19.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas19.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas20.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas20.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas21.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas21.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas22.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas22.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas23.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas23.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas24.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas24.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas25.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas25.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas26.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas26.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas27.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas27.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas28.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas28.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas29.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas29.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas30.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas30.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas31.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas31.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas32.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas32.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas33.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas33.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas34.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas34.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas35.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas35.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas36.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas36.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas37.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas37.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas38.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas38.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas39.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas39.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas40.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas40.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas41.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas41.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas42.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas42.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas43.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas43.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas44.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas44.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas45.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas45.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas46.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas46.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas47.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas47.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas48.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas48.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas49.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas49.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas50.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas50.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas51.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas51.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas52.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas52.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas53.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas53.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas54.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas54.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas55.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas55.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas56.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas56.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas57.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas57.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas58.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas58.imagen}" alt=""></div><div class="contenedorVistaPrevia">
...
prodcatelas.innerHTML += `<h4>${elas59.modelo}</h4><div class="galeria"><div class= "flecha flechai"></div><div class= "flecha flechad"></div><img src="${elas59.imagen}" alt=""></div><div class="contenedorVistaPrevia">
