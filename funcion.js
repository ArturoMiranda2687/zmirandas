...
prodcatadanza.innerHTML += `<h4>${danza29.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza29.imagen}" alt=""></div><p>Tallas disponibles: ${danza29.talla}</p><p>Tela: ${danza29.tela}</p><p>${danza29.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza30.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza30.imagen}" alt=""></div><p>Tallas disponibles: ${danza30.talla}</p><p>Tela: ${danza30.tela}</p><p>${danza30.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza31.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza31.imagen}" alt=""></div><p>Tallas disponibles: ${danza31.talla}</p><p>Tela: ${danza31.tela}</p><p>${danza31.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza32.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza32.imagen}" alt=""></div><p>Tallas disponibles: ${danza32.talla}</p><p>Tela: ${danza32.tela}</p><p>${danza32.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza33.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza33.imagen}" alt=""></div><p>Tallas disponibles: ${danza33.talla}</p><p>Tela: ${danza33.tela}</p><p>${danza33.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza34.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza34.imagen}" alt=""></div><p>Tallas disponibles: ${danza34.talla}</p><p>Tela: ${danza34.tela}</p><p>${danza34.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza35.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza35.imagen}" alt=""></div><p>Tallas disponibles: ${danza35.talla}</p><p>Tela: ${danza35.tela}</p><p>${danza35.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza36.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza36.imagen}" alt=""></div><p>Tallas disponibles: ${danza36.talla}</p><p>Tela: ${danza36.tela}</p><p>${danza36.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza37.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza37.imagen}" alt=""></div><p>Tallas disponibles: ${danza37.talla}</p><p>Tela: ${danza37.tela}</p><p>${danza37.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza38.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza38.imagen}" alt=""></div><p>Tallas disponibles: ${danza38.talla}</p><p>Tela: ${danza38.tela}</p><p>${danza38.descripcion}</p>`
prodcatadanza.innerHTML += `<h4>${danza39.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${danza39.imagen}" alt=""></div><p>Tallas disponibles: ${danza39.talla}</p><p>Tela: ${danza39.tela}</p><p>${danza39.descripcion}</p>`
...
prodcatelas.innerHTML += `<h4>${elas11.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas11.imagen}" alt=""></div><p>Tallas disponibles: ${elas11.talla}</p><p>Tela: ${elas11.tela}</p><p>${elas11.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas12.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas12.imagen}" alt=""></div><p>Tallas disponibles: ${elas12.talla}</p><p>Tela: ${elas12.tela}</p><p>${elas12.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas13.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas13.imagen}" alt=""></div><p>Tallas disponibles: ${elas13.talla}</p><p>Tela: ${elas13.tela}</p><p>${elas13.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas14.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas14.imagen}" alt=""></div><p>Tallas disponibles: ${elas14.talla}</p><p>Tela: ${elas14.tela}</p><p>${elas14.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas15.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas15.imagen}" alt=""></div><p>Tallas disponibles: ${elas15.talla}</p><p>Tela: ${elas15.tela}</p><p>${elas15.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas16.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas16.imagen}" alt=""></div><p>Tallas disponibles: ${elas16.talla}</p><p>Tela: ${elas16.tela}</p><p>${elas16.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas17.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas17.imagen}" alt=""></div><p>Tallas disponibles: ${elas17.talla}</p><p>Tela: ${elas17.tela}</p><p>${elas17.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas18.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas18.imagen}" alt=""></div><p>Tallas disponibles: ${elas18.talla}</p><p>Tela: ${elas18.tela}</p><p>${elas18.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas19.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas19.imagen}" alt=""></div><p>Tallas disponibles: ${elas19.talla}</p><p>Tela: ${elas19.tela}</p><p>${elas19.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas20.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas20.imagen}" alt=""></div><p>Tallas disponibles: ${elas20.talla}</p><p>Tela: ${elas20.tela}</p><p>${elas20.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas21.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas21.imagen}" alt=""></div><p>Tallas disponibles: ${elas21.talla}</p><p>Tela: ${elas21.tela}</p><p>${elas21.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas22.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas22.imagen}" alt=""></div><p>Tallas disponibles: ${elas22.talla}</p><p>Tela: ${elas22.tela}</p><p>${elas22.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas23.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas23.imagen}" alt=""></div><p>Tallas disponibles: ${elas23.talla}</p><p>Tela: ${elas23.tela}</p><p>${elas23.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas24.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas24.imagen}" alt=""></div><p>Tallas disponibles: ${elas24.talla}</p><p>Tela: ${elas24.tela}</p><p>${elas24.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas25.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas25.imagen}" alt=""></div><p>Tallas disponibles: ${elas25.talla}</p><p>Tela: ${elas25.tela}</p><p>${elas25.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas26.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas26.imagen}" alt=""></div><p>Tallas disponibles: ${elas26.talla}</p><p>Tela: ${elas26.tela}</p><p>${elas26.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas27.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas27.imagen}" alt=""></div><p>Tallas disponibles: ${elas27.talla}</p><p>Tela: ${elas27.tela}</p><p>${elas27.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas28.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas28.imagen}" alt=""></div><p>Tallas disponibles: ${elas28.talla}</p><p>Tela: ${elas28.tela}</p><p>${elas28.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas30.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas30.imagen}" alt=""></div><p>Tallas disponibles: ${elas30.talla}</p><p>Tela: ${elas30.tela}</p><p>${elas30.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas31.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas31.imagen}" alt=""></div><p>Tallas disponibles: ${elas31.talla}</p><p>Tela: ${elas31.tela}</p><p>${elas31.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas32.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas32.imagen}" alt=""></div><p>Tallas disponibles: ${elas32.talla}</p><p>Tela: ${elas32.tela}</p><p>${elas32.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas33.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas33.imagen}" alt=""></div><p>Tallas disponibles: ${elas33.talla}</p><p>Tela: ${elas33.tela}</p><p>${elas33.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas34.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas34.imagen}" alt=""></div><p>Tallas disponibles: ${elas34.talla}</p><p>Tela: ${elas34.tela}</p><p>${elas34.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas35.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas35.imagen}" alt=""></div><p>Tallas disponibles: ${elas35.talla}</p><p>Tela: ${elas35.tela}</p><p>${elas35.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas36.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas36.imagen}" alt=""></div><p>Tallas disponibles: ${elas36.talla}</p><p>Tela: ${elas36.tela}</p><p>${elas36.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas37.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas37.imagen}" alt=""></div><p>Tallas disponibles: ${elas37.talla}</p><p>Tela: ${elas37.tela}</p><p>${elas37.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas38.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas38.imagen}" alt=""></div><p>Tallas disponibles: ${elas38.talla}</p><p>Tela: ${elas38.tela}</p><p>${elas38.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas39.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas39.imagen}" alt=""></div><p>Tallas disponibles: ${elas39.talla}</p><p>Tela: ${elas39.tela}</p><p>${elas39.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas40.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas40.imagen}" alt=""></div><p>Tallas disponibles: ${elas40.talla}</p><p>Tela: ${elas40.tela}</p><p>${elas40.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas41.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas41.imagen}" alt=""></div><p>Tallas disponibles: ${elas41.talla}</p><p>Tela: ${elas41.tela}</p><p>${elas41.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas42.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas42.imagen}" alt=""></div><p>Tallas disponibles: ${elas42.talla}</p><p>Tela: ${elas42.tela}</p><p>${elas42.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas43.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas43.imagen}" alt=""></div><p>Tallas disponibles: ${elas43.talla}</p><p>Tela: ${elas43.tela}</p><p>${elas43.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas44.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas44.imagen}" alt=""></div><p>Tallas disponibles: ${elas44.talla}</p><p>Tela: ${elas44.tela}</p><p>${elas44.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas45.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas45.imagen}" alt=""></div><p>Tallas disponibles: ${elas45.talla}</p><p>Tela: ${elas45.tela}</p><p>${elas45.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas46.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas46.imagen}" alt=""></div><p>Tallas disponibles: ${elas46.talla}</p><p>Tela: ${elas46.tela}</p><p>${elas46.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas47.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas47.imagen}" alt=""></div><p>Tallas disponibles: ${elas47.talla}</p><p>Tela: ${elas47.tela}</p><p>${elas47.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas48.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas48.imagen}" alt=""></div><p>Tallas disponibles: ${elas48.talla}</p><p>Tela: ${elas48.tela}</p><p>${elas48.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas49.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas49.imagen}" alt=""></div><p>Tallas disponibles: ${elas49.talla}</p><p>Tela: ${elas49.tela}</p><p>${elas49.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas50.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas50.imagen}" alt=""></div><p>Tallas disponibles: ${elas50.talla}</p><p>Tela: ${elas50.tela}</p><p>${elas50.descripcion}</p>`
prodcatelas.innerHTML += `<h4>${elas51.modelo}</h4><div class="galeria"><div class="flechai"></div><div class="flechad"></div><img src="${elas51.imagen}" alt=""></div><p>Tallas disponibles: ${elas51.talla}</p><p>Tela: ${elas51.tela}</p><p>${elas51.descripcion}</p>`